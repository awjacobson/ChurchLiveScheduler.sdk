...
public interface IChurchLiveSchedulerClient
{
    ...
    Task<IEnumerable<SeriesDto>?> GetSeriesListAsync(CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<CancellationDto>?> GetCancellationListAsync(int seriesId, CancellationToken cancellationToken = default);
    ...
    Task<IEnumerable<SpecialDto>?> GetSpecialsAsync(CancellationToken cancellationToken = default);
